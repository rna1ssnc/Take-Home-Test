document.addEventListener('DOMContentLoaded', () => {
    const serverUrl = 'http://127.0.0.1:5000/get-activities'; // Change to your actual endpoint
    ...
    async function fetchData() {
        try {
            ...
            if (response.ok) {
                ...
                console.errordocument.addEventListener('DOMContentLoaded', () => {
                    const serverUrl = 'http://127.0.0.1:5000/get-activities';
                    const dataTable = document.getElementById('data-table').getElementsByTagName('tbody')[0];
                    let data = [];
